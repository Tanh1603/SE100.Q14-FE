    ...
    return (
      <div className="flex items-center justify-between p-4 border-t">
        <p className="text-sm text-gray-500">
          Trang {meta.currentPage} / {meta.totalPages} ({meta.totalItems} kết
          quả)
        </p>
  ...
  return (
    <SidebarInset>
      <div className="mx-5 pb-10">
        ...
        <div className="bg-white p-4 rounded-xl border shadow-sm mb-6 space-y-4 overflow-x-auto">
          <div className="flex gap-4 min-w-[300px] md:min-w-0">
