      ...
      >
        ...
        <Card className="border-none shadow-none">
          ...
          <CardContent className="px-0 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start justify-center border-t border-b py-6 bg-gray-50/50 rounded-lg">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-xs">Nghề nghiệp</FormLabel>
                      <FormControl>
                        <Input placeholder="Nghề nghiệp vợ/chồng" {...field} />
                      </FormControl>
                    </FormItem>
                  )}
                />
        ...
        <div className="flex justify-end gap-4 sticky bottom-0 bg-white p-4 border-t shadow-lg z-10 rounded-t-xl">
          <Button variant="outline" type="button">
            Hủy bỏ
          </Button>
          <Button
            type="submit"
            className="min-w-[150px] shadow-md hover:shadow-lg transition-shadow"
          >
